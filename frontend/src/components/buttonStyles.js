export function buttonStyles({ variant = 'primary', size = 'md', className = '' } = {}) {
  ...
  return [
    'inline-flex shrink-0 items-center justify-center gap-2 whitespace-nowrap rounded-lg border font-bold outline-none transition-colors duration-150 active:translate-y-px disabled:pointer-events-none disabled:opacity-50 focus-visible:ring-2 focus-visible:ring-zinc-950 focus-visible:ring-offset-2',
